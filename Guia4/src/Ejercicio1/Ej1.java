 ...
 * tienda de libros. Cada libro tiene un título, un autor, un precio, y el año
 * de
 ...
 * Consideraciones adicionales:- Crea una clase Libro que tenga atributos para
 * el título, autor, precio y año
 * de publicación.- Asegúrate de agregar validaciones de entrada para garantizar
 * que los
